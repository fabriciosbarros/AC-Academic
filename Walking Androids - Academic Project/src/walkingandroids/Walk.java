...
public class Walk {
    ...
    public int WalkPosition1(Android android, String filePositions1, Battery battery, int counter) throws IOException {
        ...
        while ((battery.getActualVoltage())<1 || (battery.getActualVoltage() - extraUse) < 0 || (battery.getActualVoltage() + battery.getHoldingMotors())<0 ){
            try {
        ...
        groupOne.put("Waist", android.getWaist());
        ...
        while ((groupOne.get("Left Ankle").getMoveFlexion() != 0) || (groupOne.get("Right Ankle").getMoveFlexion() != 0)
                ...
                || (groupOne.get("Right Knee").getMoveRotation() != 0) || (groupOne.get("Right Hip").getMoveRotation() != 0) || (groupOne.get("Waist").getMoveRotation() != 0)) {
            try {
                Thread.sleep(milisecond);
            } catch (InterruptedException ex) {
                Logger.getLogger(Android.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public int WalkPosition2(Android android, String filePositions2, Battery battery, int counter) throws IOException {
        ...
        while ((groupOne.get("Left Ankle").getMoveFlexion() != 0) || (groupOne.get("Right Ankle").getMoveFlexion() != 0)                
                ...
                || (groupOne.get("Left Elbow").getMoveFlexion() != 0) || (groupOne.get("Right Elbow").getMoveFlexion() != 0)
                || (groupOne.get("Left Shoulder").getMoveRotation() != 0) || (groupOne.get("Right Shoulder").getMoveRotation() != 0) 
                || (groupOne.get("Right Knee").getMoveFlexion() != 0) || (groupOne.get("Waist").getMoveFlexion() != 0) || (groupOne.get("Head").getMoveFlexion() != 0) ) {
            try {
                Thread.sleep(milisecond);
            } catch (InterruptedException ex) {
                Logger.getLogger(Android.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public int WalkPosition3(Android android, String filePositions3, Battery battery, int counter) throws IOException {
        android.SetArticulations(filePositions3);
        mc.PositiveDegree(android);
        double extraUse = mc.CheckMaximumUsage(android);
        Map<String, Articulation> groupOne = new HashMap();

        while ((battery.getActualVoltage())<2 ||(battery.getActualVoltage() - extraUse) < 0 || (battery.getActualVoltage() + battery.getHoldingMotors())<0) {
            try {
                Thread.sleep(milisecond);
            } catch (InterruptedException ex) {
                Logger.getLogger(Android.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public int WalkPosition4(Android android, String filePositions4, Battery battery, int counter) throws IOException {
    android.SetArticulations(filePositions4);
        mc.PositiveDegree(android);
        double extraUse = mc.CheckMaximumUsage(android);
        Map<String, Articulation> groupOne = new HashMap();
    ...
    public int WalkPosition5(Android android, String filePositions5, Battery battery, int counter) throws IOException {
    android.SetArticulations(filePositions5);
        mc.PositiveDegree(android);
        double extraUse = mc.CheckMaximumUsage(android);
        Map<String, Articulation> groupOne = new HashMap();
